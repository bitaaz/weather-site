    ...
    <div className="container mt-3 align-items-center d-flex justify-content-center">
      <div className="card weather-card" style={{ borderRadius: "20px" }}>
        <div className="card-body mx-1">
          <div className="row">
            <div className="col">
              <h5 className="fw-bold">
                Weather Today in {info.location.name}, {info.location.region},{" "}
                {info.location.country}
              </h5>
              <h2 className="fw-bold ms-3 mt-4 fs-1">
            ...
            <div className="col d-flex">
              <div className="col d-flex">
                <svg
                  ...
                  height="20"
                  fill="currentColor"
                  className="bi bi-sunrise mt-1 me-2"
                  viewBox="0 0 16 16"
                >
              ...
              <div className="col d-flex">
                <svg
                  ...
                  height="20"
                  fill="currentColor"
                  className="bi bi-sunset mt-1 me-2"
                  viewBox="0 0 16 16"
                >
          ...
          <div className="row" style={{ fontWeight: "400" }}>
            <div
              className="col d-flex border-top pt-1"
            ...
            >
              <div className="col-9 d-flex ">
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className="bi bi-thermometer mt-1 me-1"
                  viewBox="0 0 16 16"
                >
            ...
            <div className="col d-flex border-top pt-1">
            ...
            >
              <div className="col-9 d-flex">
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className="bi bi-moisture mt-1 me-1"
                  viewBox="0 0 16 16"
                >
            ...
            <div className="col d-flex border-top pt-1">
              <div className="col-8 d-flex">
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className="bi bi-droplet-half mt-1 me-1"
                  viewBox="0 0 16 16"
                >
              ...
              <div className="col">
                <p>
                  {
                    info.forecast.forecastday[0].hour[currentDate.getHours()]
                      .dewpoint_c
                  }
                  °
                </p>
            ...
            >
              <div className="col-9 d-flex">
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className="bi bi-arrows-collapse mt-1 me-1"
                  viewBox="0 0 16 16"
                >
              ...
              <div className="col">
                <p>{info.current.pressure_mb} mb</p>
              </div>
            </div>
            <div className="col d-flex border-top pt-1">
              <div className="col-8 d-flex">
            ...
            <div className="col d-flex border-top pt-1 ">
              <div className="col-8 d-flex">
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className="bi bi-moon mt-1 me-1"
                  viewBox="0 0 16 16"
                >
              ...
              <div className="col">
                <p>{info.forecast.forecastday[0].astro.moon_phase}</p>
              </div>
            </div>
          </div>
        </div>
